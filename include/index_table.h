 ...
 * @brief Index table implementation for managing file positions in a linear array.
 *
 * The index table maintains a dynamic array of file positions with associated identifiers,
 * providing efficient O(1) access to positions by ID. This is particularly useful for
 * file systems or database implementations that need direct access to stored records.
 *
